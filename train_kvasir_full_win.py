...
# -----------------------
def save_gradcam(model, img_tensor, target_class, save_path, layer_name="layer4", device="cpu"):
    model.eval()
...
if __name__ == "__main__":
    ...
    weights = ResNet18_Weights.DEFAULT   # <- this replaces pretrained=True
    ...
    for epoch in range(num_epochs):
        ...
        if epoch == 0:
            # Save model
            model_path = r"resnet18_kvasir.pth"
